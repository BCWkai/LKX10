...
public class NewsAdapter extends BaseAdapter{
    ...
    public NewsAdapter(SeniorViewActivity context, List<News> dataList) {
        mContext = context;
        mDataList = dataList;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (null == convertView) {
            ...
            holder.icomIV = convertView.findViewById(R.id.iv_icon);
        ...
        holder.icomIV.setImageResource(news.getpicId());
        holder.tltTV.setText(news.getTitle());

        holder.icomIV.setOnClickListener(new View.OnClickListener() {
            @Override
